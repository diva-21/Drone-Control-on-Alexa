...
def get_test_response(intent):
    ...
    for i in connection_ids:
        apig_management_client = boto3.client('apigatewaymanagementapi', endpoint_url=f'https://484rgfnxxi.execute-api.us-west-2.amazonaws.com/production')
